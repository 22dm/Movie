...
public interface StatisticsMapper {
     ...
     * @return
     */
    List<MoviePlacingRateByDate> selectMoviePlacingRateByDate(@Param("date") Date date, @Param("nextDate") Date nextDate);


    /**
     * 查询获取最近days天内，票房最高的movieNum个电影
     * @param days
     * @param movieNum
     * @return
     */
    List<MovieTotalBoxOffice> selectMovieTotalBoxOfficeInDays(@Param("days") int days, @Param("movieNum") int movieNum);

    List<UserCost> selectTopUser(int cost);
}
